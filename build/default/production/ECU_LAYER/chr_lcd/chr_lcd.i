...
# 13 "ECU_LAYER/chr_lcd/../../MCAL_Layer/std_libraries.h" 2
...
# 14 "ECU_LAYER/chr_lcd/../../MCAL_Layer/std_libraries.h" 2
...
# 11 "ECU_LAYER/chr_lcd/../../MCAL_Layer/mcal_std_types.h" 2
...
# 25 "ECU_LAYER/chr_lcd/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 25 "ECU_LAYER/chr_lcd/../../MCAL_Layer/GPIO/hal_gpio.h" 2
...
# 11 "ECU_LAYER/chr_lcd/chr_lcd.c" 2
...
static Std_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 coloumn)
{
    ...
    else
    {
        switch(row)
        {
            case 1: lcd_8bit_send_command(lcd, (0X80 + (coloumn -1))); break;
            case 2: lcd_8bit_send_command(lcd, (0XC0 + (coloumn -1))); break;
            case 3: lcd_8bit_send_command(lcd, (0X94 + (coloumn -1))); break;
            case 4: lcd_8bit_send_command(lcd, (0XD4 + (coloumn -1))); break;
...
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 coloumn)
{
    ...
    else
    {
        switch(row)
        {
            case 1: lcd_4bit_send_command(lcd, (0X80 + (coloumn -1))); break;
            case 2: lcd_4bit_send_command(lcd, (0XC0 + (coloumn -1))); break;
            case 3: lcd_4bit_send_command(lcd, (0X94 + (coloumn -1))); break;
            case 4: lcd_4bit_send_command(lcd, (0XD4 + (coloumn -1))); break;
            default: ret = (Std_ReturnType)0x00;
